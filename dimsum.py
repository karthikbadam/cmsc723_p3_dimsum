...
class BIO:
    ...
    # come next.
    # TODO: Can anything be done here to improve performance in specific scenarios (B appears first and leads to wrong predictions for rest)
    def valid_next(self):
        valid = []
...
# TODO: 1-F Loss function not showing any improvement in performance --- check out why
class MWE(pyvw.SearchTask):
    ...
    # Features based on the individual words, bi-grams (prev, curr and curr, next), and skip-grams (prevprev, curr and curr, nextnext) are already defined
    # TODO: Features based on the Wordnet dataset are faulty --- not giving any significant improvement.
